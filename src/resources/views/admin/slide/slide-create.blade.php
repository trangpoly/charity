...
@section('content')
    <div class="container">
        <div class="bg-blue-700 px-5 py-2">
            <p class="text-white font-semibold">Slide Create</p>
        </div>
        <form action="{{ route('web.admin.slide.store') }}" method="POST" class="w-8/12 ml-24 mt-5" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mt-5">
                ...
                <div class="flex ml-10 mt-2" id="preview-image"></div>
            </div>
            <div class="flex mt-5">
                ...
                <div class="w-9/12 flex space-x-8 text-gray-700">
                    <div class="flex-col">
                        <div class="space-x-2">
                            <input type="radio" id="1" name="status" value="0" checked>
