    ...
    <div class="container">
        <form action="" method="" class="w-full h-fix">
            <div class="input flex mb-5 space-x-4">
                ...
                <div class="">
                    <p class="text-black font-semibold">Actor</p>
                ...
                <tbody>
                    ...
                    <tr
                        ...
                        <td scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <img src="https://images.pexels.com/photos/33109/fall-autumn-red-season.jpg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                                style="width: 100px; height: 67px" alt="">
                        </td>
                        <td id="btn-box-{{ $key }}" class="py-4 px-6">
                            @if ($slide->status == 0)
                            <button type="button" id="btn-active-{{ $key }}"
                                onclick="disableSlide('{{ $slide->id }}', '{{ $key }}')"
                                class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                                Active
                            </button>
                            @elseif ($slide->status == 1)
                            <button type="button" id="btn-disable-{{ $key }}"
