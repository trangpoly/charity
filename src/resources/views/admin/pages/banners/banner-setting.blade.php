                    ...
                    @if ($banner->index_position == 1)
                        <div id="box-top-banner" class="relative w-1/3 mt-2 bg-white border-2 border-gray-700">
                            <div class="flex justify-center items-center">
                                <label id="label-top-banner" for="top-banner-input"
                                    ...
                                    <img id="top-banner" class="object-fill h-full w-full"
                                        src="{{ $banner->path == '' ? 'https://d1icd6shlvmxi6.cloudfront.net/gsc/YX3NNB/b6/de/a7/b6dea7057dc849ddb4efc5c7ac6a3af3/images/create_category/u40.svg?pageId=fc344ff3-0f48-40b8-905b-b57fafc3e11c' : Illuminate\Support\Facades\Storage::url("banners/$banner->path") }}"
                                        alt="">
                                    <input type="text" value="{{ $banner->id }}" name="id_banner_top" hidden>
                                    <input type="text" value="{{ $banner->path }}" name="path_banner_top"
                            ...
                            <button id="removeTopImg"
                                ...
                                type="button" style="{{ $banner->path == '' ? 'display:none' : 'display:block' }}">
                    ...
                    @if ($banner->index_position == 2)
                        <div class="relative w-1/3 mt-2 bg-white border-2 border-gray-700">
                            <div class="flex justify-center items-center">
                                <label id="label-mid-banner" for="mid-banner-input"
                                    ...
                                    <img id="mid-banner" class="object-fill h-full w-full"
                                        src="{{ $banner->path == '' ? 'https://d1icd6shlvmxi6.cloudfront.net/gsc/YX3NNB/b6/de/a7/b6dea7057dc849ddb4efc5c7ac6a3af3/images/create_category/u40.svg?pageId=fc344ff3-0f48-40b8-905b-b57fafc3e11c' : Illuminate\Support\Facades\Storage::url("banners/$banner->path") }}"
                                        alt="">
                                    <input type="text" value="{{ $banner->id }}" name="id_banner_mid" hidden>
                                    <input type="text" value="{{ $banner->path }}" name="path_banner_mid"
                            ...
                            <button id="removeMidImg" type="button"
                                style="{{ $banner->path == '' ? 'display:none' : 'display:block' }}"
                                class="absolute flex space-x-4 bg-red-500 rounded-full top-0 right-0 hover:bg-red-700 hover:text-white">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                            ...
                            <div class="flex justify-center items-center">
                                <label id="label-bot-banner" for="bot-banner-input"
                                    ...
                                    <img id="bot-banner" class="object-fill h-full w-full"
                                        src="{{ $banner->path == '' ? 'https://d1icd6shlvmxi6.cloudfront.net/gsc/YX3NNB/b6/de/a7/b6dea7057dc849ddb4efc5c7ac6a3af3/images/create_category/u40.svg?pageId=fc344ff3-0f48-40b8-905b-b57fafc3e11c' : Illuminate\Support\Facades\Storage::url("banners/$banner->path") }}"
                                        alt="">
                                    <input type="text" value="{{ $banner->id }}" name="id_banner_bot" hidden>
                                    <input type="text" value="{{ $banner->path }}" name="path_banner_bot"
