        ...
        <form action="" method="" class="w-full h-fix">
            <div class="input flex mb-5">
                <div class="w-3/12">
                    ...
                    <input type="text" class="h-8 border border-gray-300 px-2" name="name" id="product-search"
                        placeholder="Search...">
                </div>
                <div class="w-3/12">
                ...
                <div class="w-3/12">
                    ...
                    <input type="text" class="h-8 border border-gray-300 px-2" name="name" id="giver-search"
                        placeholder="Search...">
                </div>
                <div class="w-3/12">
                    <p class="text-black font-semibold">Recipient's name</p>
                    <input type="text" class="h-8 border border-gray-300 px-2" name="name" id="recipient-search"
                        placeholder="Search...">
                </div>
            </div>

            <div class=" w-full h-fit bg-yellow-200 mb-5 text-center py-2 space-x-2">
                <button type="button" id="order-search"
                    ...
                    @foreach ($orders as $key => $item)
                        <tr
                            ...
                            <td class="py-4 px-6 flex space-x-4">
                                ...
                                <a onclick="return confirm('Are you sure you want to deactivate this user?')"
                                    href="{{ route('web.admin.order.delete', ['id' => $item->id]) }}"
