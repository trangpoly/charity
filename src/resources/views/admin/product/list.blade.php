                    ...
                    @foreach ($products as $item)
                        <tr
                            ...
                            <td class="py-4 px-6">
                                @if ($item->stock == -1)
                                    <img width="50px"
                                        src="https://d1icd6shlvmxi6.cloudfront.net/gsc/YX3NNB/b6/de/a7/b6dea7057dc849ddb4efc5c7ac6a3af3/images/product_management/u157.png?pageId=0c712e26-470a-41fb-900b-f6886ea20171">
                                @else
                                    {{ $item->stock }}
                                @endif
                            </td>
                            ...
                            <td class="py-4 mt-10 px-6 flex space-x-6">
                                ...
                                <a href="{{ route('web.admin.product.delete', $item->id) }}"
