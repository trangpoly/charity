            ...
            <nav class="flex px-5 py-3 text-gray-700  rounded-lg bg-gray-50 dark:bg-gray-800 " aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                  <li class="inline-flex items-center">
                    <a href="#" class="inline-flex items-center text-md font-medium text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
                ...
                <div class="dropdown relative md:static">
                    ...
                    <button class="menu-btn focus:outline-none focus:shadow-outline flex flex-wrap items-center">
                        <div class="w-8 h-8 overflow-hidden rounded-full">
                            <img class="w-full h-full object-cover" src="https://d1icd6shlvmxi6.cloudfront.net/gsc/YX3NNB/b6/de/a7/b6dea7057dc849ddb4efc5c7ac6a3af3/images/dashboard/u26.svg?pageId=0cba15eb-7ac6-481d-a4e3-2d242946c3b9">
                        </div>
    ...
    <div class="h-screen flex flex-row flex-wrap">
        ...
        <div id="sideBar"
            ...
            <div class="flex flex-col">
                ...
                <!-- link -->
                <a href="#"
                    class="mb-3 capitalize font-medium text-md hover:text-teal-600 transition ease-in-out duration-500">
                    Dashboard
                    <img style="float: right" width="27px" src="https://cdn0.iconfinder.com/data/icons/octicons/1024/dashboard-512.png" alt="">
                </a>
                <!-- end link -->
                ...
                <a href="#"
                    class="mb-3 capitalize font-medium text-md hover:text-teal-600 transition ease-in-out duration-500">
                    Account Management
                    <img style="float: right" width="19px" src="https://d1icd6shlvmxi6.cloudfront.net/gsc/YX3NNB/b6/de/a7/b6dea7057dc849ddb4efc5c7ac6a3af3/images/dashboard/u12.svg?pageId=0cba15eb-7ac6-481d-a4e3-2d242946c3b9" alt="">
                </a>
                <!-- end link -->
                ...
                <a href="#"
                    class="mb-3 capitalize font-medium text-md hover:text-teal-600 transition ease-in-out duration-500">
                    Product Management
                    <img style="float: right" width="19px" height="18" src="https://d1icd6shlvmxi6.cloudfront.net/gsc/YX3NNB/b6/de/a7/b6dea7057dc849ddb4efc5c7ac6a3af3/images/dashboard/u28.svg?pageId=0cba15eb-7ac6-481d-a4e3-2d242946c3b9" alt="">
                </a>
                <!-- end link -->
                ...
                <a href="#"
                    class="mb-3 capitalize font-medium text-md hover:text-teal-600 transition ease-in-out duration-500">
                    Order Management
                    <img style="float: right" width="22px" height="18" src="https://d1icd6shlvmxi6.cloudfront.net/gsc/YX3NNB/b6/de/a7/b6dea7057dc849ddb4efc5c7ac6a3af3/images/dashboard/u15.png?pageId=0cba15eb-7ac6-481d-a4e3-2d242946c3b9" alt="">
                </a>
                <!-- end link -->
                <!-- link -->
                <a href="#"
                    class="mb-3 capitalize font-medium text-md hover:text-teal-600 transition ease-in-out duration-500">
                    Banner Management
                    <img style="float: right" src="https://d1icd6shlvmxi6.cloudfront.net/gsc/YX3NNB/b6/de/a7/b6dea7057dc849ddb4efc5c7ac6a3af3/images/dashboard/u18.svg?pageId=0cba15eb-7ac6-481d-a4e3-2d242946c3b9" alt="">
                </a>
                <!-- end link -->
                <!-- link -->
                <a href="#"
                    class="mb-3 capitalize font-medium text-md hover:text-teal-600 transition ease-in-out duration-500">
                    Log Out
                    <img style="float: right" src="https://d1icd6shlvmxi6.cloudfront.net/gsc/YX3NNB/b6/de/a7/b6dea7057dc849ddb4efc5c7ac6a3af3/images/dashboard/u30.svg?pageId=0cba15eb-7ac6-481d-a4e3-2d242946c3b9" alt="">
                </a>
                <!-- end link -->
            </div>
            <!-- end sidebar content -->
