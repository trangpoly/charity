<a href="{{ route('web.client.giver-posts') }}"
    ...
    @if (url()->current() == route('web.client.giver-posts') ||
        url()->current() == route('web.client.giver-posts.not-registered') ||
        url()->current() == route('web.client.giver-posts.marked-soldout') ||
        url()->current() == route('web.client.giver-posts.gived')) bg-lime-100 @endif hover:bg-lime-100">
...
<a href="{{ route('web.client.registered') }}"
    ...
    @if (url()->current() == route('web.client.registered') ||
        url()->current() == route('web.client.received') ||
        url()->current() == route('web.client.canceled')) bg-lime-100 @endif hover:bg-lime-100">
    <div class="w-full flex border-b border-lime-500">
...
<a type="button" class="cursor-pointer w-full flex text-xl px-5 font-semibold text-gray-800 hover:bg-lime-100"
...
<a href="{{ route('web.logout') }}" class="w-full flex text-xl px-5 font-semibold text-gray-800 hover:bg-lime-100">
