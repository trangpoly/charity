<nav x-data="{ open: false }" class="bg-white border-b-2 border-gray-200 fixed top-0 left-0 w-full z-50">
    ...
    <div class="flex max-w-8xl mx-auto h-24 items-center">
        ...
        <div class="lg:flex w-4/12 ml-10 items-center text-base text-gray-700 sm:hidden">
            ...
            <div id="dropdownNotification" class="hidden w-1/3 bg-lime-100 rounded divide-y divide-gray-100 shadow"
                aria-labelledby="dropdownNotificationButton" data-popper-reference-hidden="" data-popper-escaped=""
                data-popper-placement="bottom"
                style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(0px, 15800.8px, 0px);">
                <div class="overflow-y-auto h-[600px] divide-y divide-gray-100 dark:divide-gray-700">
                    <a href="#" class="flex h-24 py-3 px-4 hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <a href="#" class="flex h-24 py-3 px-4 hover:bg-gray-100 dark:hover:bg-gray-700">
                        <div class="relative flex-shrink-0">
                            <img class="w-11 h-11 rounded-full"
                                src="https://cdn-icons-png.flaticon.com/512/147/147144.png" alt="Joseph image">
                            <div
                    ...
                    <a href="#" class="flex h-24 py-3 px-4 hover:bg-gray-100 dark:hover:bg-gray-700">
                        <div class="relative flex-shrink-0">
                            <img class="w-11 h-11 rounded-full"
                                src="https://cdn-icons-png.flaticon.com/512/147/147144.png" alt="Leslie image">
                            <div
                    ...
                    <a href="#" class="flex h-24 py-3 px-4 hover:bg-gray-100 dark:hover:bg-gray-700">
                        <div class="relative flex-shrink-0">
                            <img class="w-11 h-11 rounded-full"
                                src="https://cdn-icons-png.flaticon.com/512/147/147144.png" alt="Robert image">
                            <div
