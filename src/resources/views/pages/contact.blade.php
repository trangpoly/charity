<x-app-layout>
    <div class="container py-24 px-6 mx-auto flex bg-white">
        ...
        <div class="flex flex-wrap">
            ...
            <p class="text-gray-500 mb-2 text-xl">Địa Chỉ: Tầng 5, Tòa NIC, Tôn Thất Thuyết, Hoàng Mai, Hà Nội</p>
            ...
            <form>
                ...
                " id="exampleFormControlTextarea13" rows="3" placeholder="Lời Nhắn..."></textarea>
                </div>
