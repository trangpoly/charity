<x-app-layout>
    ...
    <div class="w-4/12 h-fit">
        ...
        @else
            <div class="w-full border border-gray-300 h-72">
                <img id="top-banner" class="object-fill h-full w-full"
                    src="https://scontent.fhan5-8.fna.fbcdn.net/v/t1.15752-9/311022761_426481996345482_418573754572453898_n.png?_nc_cat=106&ccb=1-7&_nc_sid=ae9488&_nc_ohc=ADIb973_k_EAX9sd3om&_nc_ht=scontent.fhan5-8.fna&oh=03_AdQ-jWHdqKA2dViblQUBv65XJVmGYUMIqJuIAtI7LArJ9g&oe=63897D81"
                    alt="">
            </div>
        @endif
        <div class="w-full border border-gray-300 h-fit mt-10">
            <form action="{{ route('web.client.product.submitSearch', $id) }}" method="GET">
                ...
                <div class="w-full flex text-lg px-5 text-gray-800">
                ...
                <div class="w-full text-lg px-5 text-gray-800">
                    ...
                    <div class="w-full flex text-gray-800">
                        <div class="w-full border-b border-lime-500">
                            <p class="w-full text-2xl py-5 font-semibold">Hạn sử dụng</p>
                            <div class="w-full pb-6 flex ">
                                <input class="w-6/12" type="date" name="dateStart">
                                <p class="font-semibold text-2xl mt-2 mx-4">~</p>
                                <input class="w-6/12" type="date" name="dateEnd">
                            </div>
                        </div>
                    </div>
                    <div class="w-full flex text-2xl text-gray-800 hover:bg-lime-100">
                        <div class="w-full space-x-4 mt-4 mb-4">
                            <input type="checkbox" name="expired" value="1" class="w-6 h-6">
