                    ...
                    <div class="w-full flex border border-gray-300 rounded-md space-x-10 mt-5 p-5">
                        @foreach ($recommend as $item)
                            <div class="w-3/12 relative p-2">
                                ...
                                <div class="flex py-2 space-x-4  ">
                                    <img class="h-fit"
                                        src="https://d1icd6shlvmxi6.cloudfront.net/gsc/YX3NNB/b6/de/a7/b6dea7057dc849ddb4efc5c7ac6a3af3/images/chi_ti_t_s_n_ph_m_-_ng__i_t_ng/u139.svg?pageId=04d69dba-73c1-476e-b61e-a826cf89da1e"
                                        width="15px" alt="">
