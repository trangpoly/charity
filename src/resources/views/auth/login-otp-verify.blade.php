<x-app-layout>
    <div class="w-[800px] bg-white border-gray-500 shadow m-auto content-center my-6">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" action="{{ route('web.login.store') }}" method="POST">
                @csrf
                ...
                <div class="w-full text-center relative">
                    ...
                    <a href="{{ route('web.login.show') }}" class="text-lg font-light text-blue-700 underline absolute right-0">
                        Quay về đăng nhập
                    </a>
                </div>
            </form>
